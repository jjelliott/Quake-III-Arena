...
/*
=================
UI_BotladderMenu_SetBots
=================
*/
static void UI_BotladderMenu_SetBots( void ) {
	char	*p;
	char	*bot;
	char	*botInfo;
...
/*
=================
UI_BotladderMenu_SetMenuItems
=================
*/
static void UI_BotladderMenu_SetMenuArena( int n, int level, const char *arenaInfo ) {
	char		map[MAX_QPATH];
...
static void UI_BotladderMenu_SetMenuItems( void ) {
	int			n;
	int			level;
	...
	if( selectedArenaSet == trainingTier ) {
		...
		UI_BotladderMenu_SetMenuArena( 0, level, arenaInfo );
		...
		for ( n = 0; n < 4; n++ ) {
			...
			UI_BotladderMenu_SetMenuArena( n, level, arenaInfo );
		}
...
/*
=================
UI_BotladderMenu_ResetEvent
=================
*/
static void UI_BotladderMenu_ResetDraw( void ) {
...
static void UI_BotladderMenu_ResetAction( qboolean result ) {
	if( !result ) {
		return;
	}
...
static void UI_BotladderMenu_ResetEvent( void* ptr, int event )
{
	if (event != QM_ACTIVATED) {
		return;
	}

	UI_ConfirmMenu( "RESET GAME?", UI_BotladderMenu_ResetDraw, UI_BotladderMenu_ResetAction );
}


/*
=================
UI_BotladderMenu_LevelEvent
=================
*/
static void UI_BotladderMenu_LevelEvent( void* ptr, int notification ) {
...
/*
=================
UI_BotladderMenu_LeftArrowEvent
=================
*/
static void UI_BotladderMenu_LeftArrowEvent( void* ptr, int notification ) {
	if (notification != QM_ACTIVATED) {
		return;
	}
...
/*
=================
UI_BotladderMenu_RightArrowEvent
=================
*/
static void UI_BotladderMenu_RightArrowEvent( void* ptr, int notification ) {
	if (notification != QM_ACTIVATED) {
		return;
	}
...
/*
=================
UI_BotladderMenu_PlayerEvent
=================
*/
static void UI_BotladderMenu_PlayerEvent( void* ptr, int notification ) {
	if (notification != QM_ACTIVATED) {
		return;
	}
...
/*
=================
UI_BotladderMenu_AwardEvent
=================
*/
static void UI_BotladderMenu_AwardEvent( void* ptr, int notification ) {
	int		n;
...
/*
=================
UI_BotladderMenu_NextEvent
=================
*/
static void UI_BotladderMenu_NextEvent( void* ptr, int notification ) {
	if (notification != QM_ACTIVATED) {
		return;
	}
...
/*
=================
UI_BotladderMenu_BackEvent
=================
*/
static void UI_BotladderMenu_BackEvent( void* ptr, int notification ) {
	if (notification != QM_ACTIVATED) {
		return;
	}
...
/*
=================
UI_BotladderMenu_CustomEvent
=================
*/
static void UI_BotladderMenu_CustomEvent( void* ptr, int notification ) {
	if (notification != QM_ACTIVATED) {
		return;
	}
...
/*
=================
UI_BotladderMenu_MenuDraw
=================
*/
#define LEVEL_DESC_LEFT_MARGIN		332

static void UI_BotladderMenu_MenuDraw( void ) {
	int				n, i;
	int				x, y;
	vec4_t			color;
	int				level;
...
/*
=================
UI_BotladderMenu_Init
=================
*/
static void UI_BotladderMenu_Init( void ) {
	int		skill;
	int		n;
	int		x, y;
	int		count;
	...
	levelMenuInfo.menu.draw = UI_BotladderMenu_MenuDraw;
	...
	levelMenuInfo.item_leftarrow.generic.callback	= UI_BotladderMenu_LeftArrowEvent;
	...
	levelMenuInfo.item_maps[0].generic.callback		= UI_BotladderMenu_LevelEvent;
	...
	levelMenuInfo.item_maps[1].generic.callback		= UI_BotladderMenu_LevelEvent;
	...
	levelMenuInfo.item_maps[2].generic.callback		= UI_BotladderMenu_LevelEvent;
	...
	levelMenuInfo.item_maps[3].generic.callback		= UI_BotladderMenu_LevelEvent;
	...
	levelMenuInfo.item_rightarrow.generic.callback	= UI_BotladderMenu_RightArrowEvent;
	...
	levelMenuInfo.item_player.generic.callback		= UI_BotladderMenu_PlayerEvent;
	...
	for( n = 0; n < 6; n++ ) {
		if( levelMenuInfo.awardLevels[n] ) {
			...
			levelMenuInfo.item_awards[count].generic.callback	= UI_BotladderMenu_AwardEvent;
	...
	levelMenuInfo.item_back.generic.callback		= UI_BotladderMenu_BackEvent;
	...
	levelMenuInfo.item_reset.generic.callback		= UI_BotladderMenu_ResetEvent;
	...
	levelMenuInfo.item_custom.generic.callback		= UI_BotladderMenu_CustomEvent;
	...
	levelMenuInfo.item_next.generic.callback		= UI_BotladderMenu_NextEvent;
