code
proc grunt_stand 0 0
endproc grunt_stand 0 0
proc grunt_walk 0 0
endproc grunt_walk 0 0
proc grunt_run 0 0
endproc grunt_run 0 0
proc grunt_attack 0 0
endproc grunt_attack 0 0
proc grunt_pain 0 0
endproc grunt_pain 0 0
proc grunt_die 0 0
endproc grunt_die 0 0
export SP_monster_grunt_q1
proc SP_monster_grunt_q1 0 0
endproc SP_monster_grunt_q1 0 0
import AI_SetMoveTarget
import AI_Touch_MoveTarget
import SP_path_corner_q1
import AI_RunFrame
import AI_WalkFrame
import AI_StandFrame
